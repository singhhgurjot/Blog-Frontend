...
export default function welcome() {
  return (
    <div className="w-screen">
        ...
        <div>
            <p className="font-mainfont font-black text-5xl mt-20 ml-10 ">UNLEASH YOUR THOUGHTS!</p>
        <p className="font-mainfont ml-10 text-5xl font-black diveinto mt-3">dive into scribblesphere </p>
